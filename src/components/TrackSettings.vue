<template>
    <div class="bg-background rounded-lg p-4 drop-shadow-md  w-full">
        <p class="font-semibold text-xl truncate" v-if="typeof track !== 'undefined'">Track
            Settings
            • {{
                track.name
            }}</p>
        ...
        <div class="flex justify-end items-center mt-4">
            ...
            <button type="button"
                ...
                @click="saveTrackSettings">Save</button>
        </div>
    </div>
    <ConfirmationPrompt ref="removePrompt" buttonText="Löschen" header="Möchtest du den Track wirklich löschen?"
