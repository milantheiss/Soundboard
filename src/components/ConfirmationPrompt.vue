                        ...
                        <DialogPanel
                            ...
                            <div class="bg-inherit px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <DialogTitle as="h2" class="text-xl font-medium leading-6 text-white">{{ header }}
                                        </DialogTitle>
                                        <div class="mt-2">
                            ...
                            <div class="bg-inherit px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                ...
                                <button type="button"
                                    ...
                                    @click="open = false" ref="cancelButtonRef">Abbrechen</button>
                            </div>
                        </DialogPanel>
                    </TransitionChild>
                </div>
